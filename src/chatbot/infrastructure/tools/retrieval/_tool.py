...
from src.chatbot.contracts.observability import SPAN_CHAT_TOOL_SEARCH_DOCUMENTS
from src.chatbot.contracts.retrieval import Retriever, SourceChunk
...
def _json_to_source_chunk(data: dict[str, object]) -> SourceChunk:
    ...
    return SourceChunk(
        ...
        page=_opt_str("page"),
        kind=_opt_str("kind") or "text",
        image_path=_opt_str("image_path"),
    )
